...
const typeMap: any = {
    "Country": o([
        ...
        { json: "gini", js: "gini", typ: u(undefined, r("Gini")) },
    ...
    "Currencies": o([
        { json: "CRC", js: "CRC", typ: u(undefined, r("Aud")) },
        { json: "AUD", js: "AUD", typ: u(undefined, r("Aud")) },
        { json: "USD", js: "USD", typ: u(undefined, r("Aud")) },
    ], false),
    "Aud": o([
